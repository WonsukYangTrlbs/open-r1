...
def verify_mbpp_sample(content, test_cases, mode: Literal["strict", "loose"] = "strict"):
...
def extract_mmlu_like_response(content, pattern: str = "Answer:"):
    answer = content.split(pattern)[-1].strip()
    return answer
